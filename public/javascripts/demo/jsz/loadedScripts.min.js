'use strict';jsz={script:{base:"/assets/javascripts"}};
(function(){function a(a){return"function"===typeof a.equal?function(b){return a.equal(b)}:function(b){return a===b}}function b(a){return!0===a}window.script=function(a,b){a.fun=void 0===b?function(){}:b;a.evaluated=!1;a.loaded=!0;void 0===a.require&&(a.require=[]);void 0===a.name&&(a.name=uniqueId("SCRIPT"));script.map[a.name]=a;script._addDefaultRequirements(a.name);script._defaultRequirement(a.name);delete a.name;void 0!==a.base&&this._setBase(a.base);script._evalAll()};window.READY_STATE={LOADING:"loading",
INTERACTIVE:"interactive",COMPLETE:"complete"};script.map={};script.SLASH="/";script.PERIOD=".";script.PREFIX_JS=".js";script._loadedScriptName=null;script._defaultRequirements=[];script._base=null;script._counter=0;script._srcToNameRegExp=/^http.*\/\/[^/]*.(.*).js$/;script._preloaded=[];script.init=function(a){void 0!==a.base&&this._setBase(a.base);script._preloaded=function(){var a=document.getElementsByTagName("script"),b=a.length,c=0,f=[];for(c;c<b;c++){var h=a.item(c).src;""!==h&&(h=script._srcToNameRegExp.exec(h),
null!==h&&f.push(h[1].replace(new RegExp(script.SLASH,"g"),script.PERIOD).substr(script._base.length-1)))}return f}();void 0!==a.preloaded&&(script._preloaded=script._preloaded.concat(a.preloaded));script._preloaded.forEach(function(a){void 0===script.map[a]&&(script.map[a]={default:!1,loaded:!0,evaluated:!0,preloaded:!0})})};script._setBase=function(a){script._base=script.SLASH+/\/*(.*[^\/])\/*/.exec(a)[1]+script.SLASH};script.load=function(a){if(null===script._base)throw Error("Script-loader not initialized! base \x3d null");
var b=document.createElement("script");b.setAttribute("src",script._src(a));b.setAttribute("type","text/javascript");b.setAttribute("async","true");document.head.appendChild(b);b={loaded:!1,evaluated:!1,preloaded:!1};return script.map[a]=b};script._src=function(a){if(/^[\w\.]*$/.test(a))return script._base+a.replace(/\./g,script.SLASH)+script.PREFIX_JS;throw Error("Wrong format! script-name \x3d "+a);};script._defaultRequirement=function(a){var b=script.map[a];void 0===b.default?b.default=script._isDefault(a):
!0===b.default&&script._defaultRequirements.push(a)};script._addDefaultRequirements=function(b){var d=script.map[b];this._defaultRequirements.forEach(function(e){script.map[e].require.some(a(b))||d.require.push(e)})};script._evalAll=function(){script._evalStack=[];Object.keys(script.map).forEach(script._eval)};document.onreadystatechange=script._evalAll;script._eval=function(c){var d=!1;if(null!==script._base){if(script._evalStack.some(a(c)))throw Error("Cycle reference in script-loader! "+script._evalStack.join(" \x3e ")+
" \x3e "+c);script._evalStack.push(c);d=script.map[c];void 0===d?d=script.load(c):d.loaded&&!d.evaluated&&(c=!1,script._isReadyToEval(d)&&(c=void 0===d.require?!0:d.require.map(script._eval).every(b)))&&(void 0!==d.fun&&d.fun.apply(window),d.evaluated=!0,delete d.fun);script._evalStack.pop();d=d.evaluated}return d};script._isReadyToEval=function(a){var b=document.readyState;a=a.onReadyState;var e=!1;a===READY_STATE.LOADING||b===READY_STATE.COMPLETE?e=!0:a===b&&(e=!0);return e};script._isDefault=function(a){var b=
!1,e,g=script._defaultRequirements.length,f=0;for(f;f<g;f++)if(e=script._defaultRequirements[f],a===e){b=!0;break}return b}})();(function(){var a;void 0===window.jsz?a={}:(a=window.jsz,delete window.jsz);window._jsz_={classes:{},version:"0.0.1",uniqueId:0,sealObjects:!0,config:{}};_jsz_.config.log=void 0===a.log?{}:a.log;void 0===a.script?_jsz_.config.script={}:(_jsz_.config.script=a.script,_jsz_.config.script.preloaded=["lib.jsz.config","lib.jsz.core.script","lib.jsz.core.config"],script.init(_jsz_.config.script))})();
script({name:"lib.jsz.core.main"},function(){window._jsz_={classes:{},version:"0.0.1",uniqueId:0,sealObjects:!0,config:{}};void 0!==window.jsz&&(void 0!==jsz.log&&(_jsz_.config.log=jsz.log),void 0!==jsz.script&&(_jsz_.config.script=jsz.script),delete window.jsz);void 0===_jsz_.log&&(_jsz_.log={});void 0===_jsz_.log.type&&(_jsz_.log.type="console");void 0!==_jsz_.config.script&&script.init(_jsz_.config.script);window.JSZ={EMPTY_STRING:"",DOT:".",BLANK:" ",SLASH:"/",NEW_LINE:"\n",PREFIX:{JS:".js"},
META:"_jsz_"};window.uniqueId=function(a){var b=++_jsz_.uniqueId;return void 0===a?"ID:"+b:a+":ID:"+b};window.unite=function(a,b){var c;void 0===a&&(a=noop);a.isUnited?c=a:(void 0===b&&(b=window),c=function(){var c=arguments;arguments[0]&&jsz.isArguments(arguments[0])&&(c=arguments[0]);return a.apply(b,c)},c.isUnited=!0,c=Object.freeze(c));return c};window.apply=function(a,b,c){2===arguments.length?Array.isArray(b)&&(c=b,b=window):void 0===b&&(b=window);return a.apply(b,c)};window.noop=function(){};
...
script({name:"demo.jsz.loadedScripts",onReadyState:READY_STATE.COMPLETE},function(){$id("scripts").html(Object.keys(script.map).reduce(function(a,b){return a+b+"\x3cbr\x3e"},JSZ.EMPTY_STRING))});